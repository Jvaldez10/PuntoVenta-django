...
from core.model1.forms import ProductForm
from core.model1.mixins import ValidatePermissionRequiredMixin
from core.model1.models import Product
...
class ProductListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('model1:product_create')
        context['list_url'] = reverse_lazy('model1:product_list')
...
class ProductCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('model1:product_list')
