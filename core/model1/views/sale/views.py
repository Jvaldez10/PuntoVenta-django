...
from core.model1.forms import SaleForm, ClientForm
from core.model1.mixins import ValidatePermissionRequiredMixin
from core.model1.models import Sale, Product, DetSale, Client
...
class SaleListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('model1:sale_create')
        context['list_url'] = reverse_lazy('model1:sale_list')
...
class SaleCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('model1:sale_list')
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            context = {
                ...
                'comp': {'name': 'UNL S.A.', 'ruc': '9999999999999', 'address': 'Milagro, Ecuador'},
            ...
            pass
        return HttpResponseRedirect(reverse_lazy('model1:sale_list'))
